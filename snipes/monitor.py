    ...
    for i in array:
        ...
        item = [
            i.find(
                "span",
                {
                    "class": "b-product-tile-brand b-product-tile-text js-product-tile-link"
                },
            ).text,
            data["name"],
            "https://www.snipes.com/"
            + i.find("a", {"class": "b-product-tile-body-link"})["href"],
            data["id"],
            data["price"],
            data["dimension25"],
            i.find("source", {"media": "(min-width: 1024px)"})["data-srcset"].split(
                ", "
            )[0],
        ]
        items.append(item)
