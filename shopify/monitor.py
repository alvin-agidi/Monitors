...
-----------------------------------\n""")
    ...
    if not check_url(URL):
        print(
            "Store URL not in correct format. Please ensure that it is a path pointing to a /products.json file"
        )
    ...
    while True:
        try:
            ...
            items = scrape_site(URL, proxies, headers)
