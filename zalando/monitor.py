...
def scrape_main_site(headers, proxy):
    ...
    for page in [1, 2, 3, 4]:
        ...
        products = soup.find_all(
            "div",
            {"class": "_5qdMrS w8MdNG cYylcv BaerYO _75qWlu iOzucJ JT3_zV _Qe9k6"},
        )
            ...
            try:
                item = [
                    product.find(
                        "h3",
                        {
                            "class": "KxHAYs lystZ1 FxZV-M _4F506m ZkIJC- r9BRio qXofat EKabf7 nBq1-s _2MyPg2"
                        },
                    ).text,  # name
                    ...
                    product.find(
                        "h3",
                        {
                            "class": "_6zR8Lt lystZ1 FxZV-M _4F506m ZkIJC- r9BRio qXofat EKabf7 nBq1-s _2MyPg2"
                        },
                    ).text,  # brand
                    product.find(
                        "p", {"class": "KxHAYs lystZ1 FxZV-M _4F506m"}
                    ).text,  # price
